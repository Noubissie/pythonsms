...
# def change_class_subject():
#     subject = ["Physics", "Chemistry", "Biology", "Mathematics", "Geography", "English Literature",
#                "English Language", "French", "Manual Labour", "Physical Education", "History",
#                "Computer Studies", "Citizenship Education"]
#     subjects = json.dumps(subject)
#     school_information.change_subjects_of_a_class(clas="Form 1").subject_thought = subjects
#     school_information.change_subjects_of_a_class(clas="Form 2").subject_thought = subjects
#     db.session.commit()
#
# def change_subject_name():
#     subject6 = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE", "HISTOIRE/GEOGRAPHIE",
#                 "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE", "INFORMATIQUE",
#                 "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL"]
#     subject5 = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE", "HISTOIRE/GEOGRAPHIE",
#                 "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE", "INFORMATIQUE",
#                 "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL"]
#
#     subject4esp = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE",
#                    "HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL", "PCT", "ESPAGNOL"]
#     subject4All = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE", "INFORMATIQUE",
#                    "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL", "PCT", "ALLEMAND"]
#     subject3All = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE",
#                    "HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES",
#                    "SCIENCES DE LA VIE ET DE LA TERRE", "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE",
#                    "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL", "PCT", "ALLEMAND"]
#     subject3esp = ["ORTHOGRAPHE", "EXPRESSION ECRITE", "ETUDE DE TEXT", "EXPRESSION ORALE", "ANGLAISE",
#                    "HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES",
#                    "SCIENCES DE LA VIE ET DE LA TERRE", "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE",
#                    "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL", "PCT", "ESPAGNOL"]
#     subject2All = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ALLEMAND"]
#     subject2esp = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ESPAGNOL"]
#     subject2c =  ["LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                   "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                   "INFORMATIQUE", "ECONOMIE SOCIAL ET FAMILIALE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                   "PHYSIQUE", "CHIMIE"]
#     subject1All = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ALLEMAND"]
#     subject1esp = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ESPAGNOL"]
#     subject1D = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                  "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                  "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL","PHYSIQUE", "CHIMIE ", "TRAVAUX PRATIQUES"]
#     subjectTall = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ALLEMAND "]
#     subjectTesp = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                    "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                    "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE", "TRAVAIL MANUEL",
#                    "ESPAGNOL"]
#     subjectTd = ["PHILOSOPHIE", "LANGUAGE FRANÇAISE", "LITERATURE", "ANGLAIS", "HISTOIRE/GEOGRAPHIE",
#                  "EDUC. A LA CITOY. ET A LA MORAL", "MATHEMATIQUES", "SCIENCES DE LA VIE ET DE LA TERRE",
#                  "INFORMATIQUE", "EDUCATION PHYSIQUE ET SPORTIVE",
#                  "TRAVAIL MANUEL", "PHYSIQUE", "CHIMIE"]
#     school_information.change_subjects_of_a_class(clas="SIXIEME").subject_thought = json.dumps(subject6)
#     school_information.change_subjects_of_a_class(clas="CINQUIEME").subject_thought = json.dumps(subject5)
#     school_information.change_subjects_of_a_class(clas="QUATRIEME ALLEMAND").subject_thought = json.dumps(subject4All)
#     school_information.change_subjects_of_a_class(clas="QUATRIEME ESPAGNOL").subject_thought = json.dumps(subject4esp)
#     school_information.change_subjects_of_a_class(clas="TROISIEME ALLEMAND").subject_thought = json.dumps(subject3All)
#     school_information.change_subjects_of_a_class(clas="TROISIEME ESPAGNOL").subject_thought = json.dumps(subject3esp)
#     school_information.change_subjects_of_a_class(clas="SECONDE ALLEMAND").subject_thought = json.dumps(subject2All)
#     school_information.change_subjects_of_a_class(clas="SECONDE ESPAGNOL").subject_thought = json.dumps(subject2esp)
#     school_information.change_subjects_of_a_class(clas="SECONDE C").subject_thought = json.dumps(subject2c)
#     school_information.change_subjects_of_a_class(clas="PREMIERE ALLEMAND").subject_thought = json.dumps(subject1All)
#     school_information.change_subjects_of_a_class(clas="PREMIERE ESPAGNOL").subject_thought = json.dumps(subject1esp)
#     school_information.change_subjects_of_a_class(clas="PREMIERE D").subject_thought = json.dumps(subject1D)
#     school_information.change_subjects_of_a_class(clas="TERMINALE ALLEMAND").subject_thought = json.dumps(subjectTall)
#     school_information.change_subjects_of_a_class(clas="TERMINALE ESPAGNOL").subject_thought = json.dumps(subjectTesp)
#     school_information.change_subjects_of_a_class(clas="TERMINALE D").subject_thought = json.dumps(subjectTd)
#     db.session.commit()
#
# change_subject_name()  #for the Francophone section changing subjects taught and correcting meistakes made during information gathering
#
# def change_madam_mballa_ionformation():
#     subject = [["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"], ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"],
#                ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"], ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"]]
#     subjectNKO =[["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"], ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"],
#                  ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"], ["HISTOIRE/GEOGRAPHIE", "EDUC. A LA CITOY. ET A LA MORAL"]]
#     Database_Registration.get_registration_from_database("mballa ndoman m").subject_thought = json.dumps(subject)
#     Database_Registration.get_registration_from_database("nkoussee").subject_thought = json.dumps(subjectNKO)
#     db.session.commit()

# def change_mr_mohamed_information():
#     subject = [["SCIENCES DE LA VIE ET DE LA TERRE"], ["SCIENCES DE LA VIE ET DE LA TERRE", "TRAVAUX PRATIQUES"],
#                ["SCIENCES DE LA VIE ET DE LA TERRE"], ["SCIENCES DE LA VIE ET DE LA TERRE"],
#                ["SCIENCES DE LA VIE ET DE LA TERRE"], ["SCIENCES DE LA VIE ET DE LA TERRE"]]
#
#     Database_Registration.get_registration_from_database("tatmoun nchouwat mouhamadou").subject_thought = json.dumps(subject)
#     db.session.commit()
#
# change_mr_mohamed_information()


# def change_monsieur_christain_information():
#     classs = ["CINQUIEME"]
#
#     subject = [["EDUC. A LA CITOY. ET A LA MORAL","HISTOIRE/GEOGRAPHIE"]]
#     Database_Registration.get_registration_from_database("indinibole behem simon pierre").subject_thought = json.dumps(subject)
#     Database_Registration.get_registration_from_database("indinibole behem simon pierre").class_thought = json.dumps(classs)
#     db.session.commit()
# change_monsieur_christain_information()
#     classs = ["SECONDE ALLEMAND","SECONDE ESPAGNOL", "SECONDE C", "PREMIERE ALLEMAND","PREMIERE ESPAGNOL", "PREMIERE D",
#               "TERMINALE ALLEMAND","TERMINALE ESPAGNOL", "TERMINALE D"]
#
#     subject = [["LANGUAGE FRANÇAISE", "LITERATURE"], ["LANGUAGE FRANÇAISE", "LITERATURE"],
#                ["LANGUAGE FRANÇAISE", "LITERATURE"], ["LANGUAGE FRANÇAISE", "LITERATURE"],
#                ["LANGUAGE FRANÇAISE", "LITERATURE"], ["LANGUAGE FRANÇAISE", "LITERATURE"],
#                ["LANGUAGE FRANÇAISE", "LITERATURE"],["LANGUAGE FRANÇAISE", "LITERATURE"],
#                ["LANGUAGE FRANÇAISE", "LITERATURE"]]
#
#     classskwitat = ["SIXIEME", "SECONDE ALLEMAND","SECONDE ESPAGNOL", "PREMIERE ALLEMAND","PREMIERE ESPAGNOL", "PREMIERE D"]
#     subjectkwitat = [
#                         ["SCIENCES DE LA VIE ET DE LA TERRE"], ["SCIENCES DE LA VIE ET DE LA TERRE"],
#                         ["SCIENCES DE LA VIE ET DE LA TERRE"], ["TRAVAIL MANUEL"],
#                         ["TRAVAIL MANUEL"], ["CHIMIE"]
#                     ]

    # Database_Registration.get_registration_from_database("mekongo atangana christian").subject_thought = json.dumps(subject)
#     Database_Registration.get_registration_from_database("mekongo atangana christian").class_thought = json.dumps(classs)
#     db.session.commit()
#     Database_Registration.get_registration_from_database("kwitat christel").subject_thought = json.dumps(subjectkwitat)
#     Database_Registration.get_registration_from_database("kwitat christel").class_thought = json.dumps(classskwitat)
#     db.session.commit()
#
#
# change_monsieur_christain_information()
# def change_all_sudents_offering_geography():
#     subject = "HISTOIRE/GEOGRAPHIE"
#     for student in subject_and_mark.get_student_offering_particular_subject("GEOGRAPHIE"):
#         student.subject = subject
#         db.session.commit()

# change_madam_mballa_ionformation()
# change_all_sudents_offering_geography()

# change_class_subject()


# def change_student_AYO_BENEDICTE_CLAUDIA():
#
#     ayo = student_information.get_particular_student(" AYO BENEDICTE CLAUDIA")
#     # print(ayo.pupils_name)
#     for student in ayo.pupils_name:
#         student.student_name = "AYO BENEDICTE CLAUDIA"
#     for student in save_student_total_mark.get_particular_student(" AYO BENEDICTE CLAUDIA"):
#         student.student_name = "AYO BENEDICTE CLAUDIA"
#
#     for student in annual_performance.get_particular_student(" AYO BENEDICTE CLAUDIA"):
#         student.student_name = "AYO BENEDICTE CLAUDIA"
#     # student_information.get_particular_student(" AYO BENEDICTE CLAUDIA").student_name = "AYO BENEDICTE CLAUDIA"
#     student_information.delete_student(" AYO BENEDICTE CLAUDIA")
#     db.session.commit()
#
# change_student_AYO_BENEDICTE_CLAUDIA()

# def del_student_from_database():
#     save_student_total_mark.delete_student("ESSOMBA OVIDI UNIS GEORGES WENCESLAS")
#     subject_and_mark.delete_student("ESSOMBA OVIDI UNIS GEORGES WENCESLAS")
#     annual_performance.delete_student("ESSOMBA OVIDI UNIS GEORGES WENCESLAS")
#     student_information.delete_student("ESSOMBA OVIDI UNIS GEORGES WENCESLAS")
#
# del_student_from_database()
...
@app.route('/')
def home():
    school = school_information.get_school_information_from_database_school_section
    sections = ["Anglophone Section", "Francophone Section"]
    return render_template('base.html', school=school, sections=sections)
...
@app.route('/report_database/<name>/<clas>', methods=['POST'])
                ...
                if len(student.pupils_name) == 0:
                    ...
                    for i in range(len(student.pupils_name)):
                        ...
                        if student.pupils_name[i].student_name == student.student_name and \
                            ...
                            if student_name != '' and student_competence != '' and student_mark != '':
...
if __name__ == '__main__':
    # app.run(host='127.0.0.1', port=10000, use_reloader=True, debug=True, threaded=True)
    app.run(host='192.168.1.2', port=10000, use_reloader=True, debug=True, threaded=True)
